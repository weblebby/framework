...
var defaults = {
    ...
    listRenderer: function (children, options) {
        var html =
            '<' + options.listNodeName + ' class="' + options.listClass + '">'
        html += children
...
Plugin.prototype = {
    ...
    _buildItem: function (item, options) {
        ...
        var html = $(
            options.itemRenderer(item_attrs, content, children, options, item),
        )
    ...
    asNestedSet: function () {
        ...
        function traverse(item, depth, lft) {
            ...
            if (
                $(item).children(o.listNodeName).children(o.itemNodeName)
                    .length > 0
            ) {
                depth++
                $(item)
    ...
    toArray: function () {
        ...
        function _recursiveArray(item, depth, left) {
            ...
            if (
                ...
                depth++
                item.children(o.options.listNodeName)
