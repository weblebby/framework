<x-weblebby::layouts.panel>
    <x-weblebby::page class="lg:fd-w-2/3 fd-mx-auto">
        <x-weblebby::page.head :back="panel_route('users.index')">
            <x-weblebby::page.title>@lang('Kullanıcı oluşturun')</x-weblebby::page.title>
            <x-weblebby::page.subtitle>@lang('Yeni bir kullanıcı oluşturun')</x-weblebby::page.subtitle>
