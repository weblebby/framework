<x-feadmin::layouts.panel>
    <x-feadmin::page class="w-2/3 mx-auto">
        <x-feadmin::page.head :back="route('admin::users.index')">
            <x-feadmin::page.title>@t('Kullanıcı oluşturun', 'admin')</x-feadmin::page.title>
            <x-feadmin::page.subtitle>@t('Yeni bir kullanıcı oluşturun', 'admin')</x-feadmin::page.subtitle>
        </x-feadmin::page.head>
        <x-feadmin::form class="space-y-3" :action="route('admin::users.store')">
