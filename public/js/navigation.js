...
var drawer = document.getElementById('drawer-create-menu-item');
var dd = document.querySelector('.dd');
var parentIdInput = drawer.querySelector('input[name="parent_id"]');
...
var Navigation = {
          ...
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return (0,_api__WEBPACK_IMPORTED_MODULE_1__["default"])("/admin/navigations/".concat(id, "/sort"), {
                    method: 'POST',
                    body: JSON.stringify({
  ...
  handleIsSmartMenu: function handleIsSmartMenu() {
...
drawer.addEventListener('drawer.open', function (_ref) {
  var _ref$detail = _ref.detail,
      related = _ref$detail.related,
      item = _ref$detail.item,
      isEdit = _ref$detail.isEdit,
      isError = _ref$detail.isError;

  if (related) {
    parentIdInput.value = related.dataset.parentId || '';
  }

  form.action = isEdit ? form.dataset.editAction.replace(':id', item.id) : defaultFormAction;
  form.querySelector('input[name="_method"]').value = isEdit ? 'PUT' : 'POST';
  var title = drawer.querySelector('input[name="title"]');
  var isSmartMenu = drawer.querySelector('input[name="is_smart_menu"]');
  var smartType = drawer.querySelector('select[name="smart_type"]');
  var smartLimit = drawer.querySelector('input[name="smart_limit"]');
  var link = drawer.querySelector('input[name="link"]');
  var isActive = drawer.querySelector('input[name="is_active"]');
  var openInNewTab = drawer.querySelector('input[name="open_in_new_tab"]');
  var linkable = drawer.querySelector('select[name="linkable"]');

  if (!isError) {
    title.value = (item === null || item === void 0 ? void 0 : item.title) || '';
    isSmartMenu.checked = (item === null || item === void 0 ? void 0 : item.type) === 3;
    smartType.value = (item === null || item === void 0 ? void 0 : item.smart_type) || '';
    smartLimit.value = (item === null || item === void 0 ? void 0 : item.smart_limit) || '';
    link.value = (item === null || item === void 0 ? void 0 : item.link) || '';
    isActive.checked = item === null || item === void 0 ? void 0 : item.is_active;
    openInNewTab.checked = item === null || item === void 0 ? void 0 : item.open_in_new_tab;
